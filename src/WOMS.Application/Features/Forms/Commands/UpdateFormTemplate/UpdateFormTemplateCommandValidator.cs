...
namespace WOMS.Application.Features.Forms.Commands.UpdateFormTemplate
{
    public class UpdateFormTemplateCommandValidator : AbstractValidator<UpdateFormTemplateCommand>
    {
        ...
        {
            RuleFor(x => x.Id)
                .NotEmpty().WithMessage("Form template ID is required.");
            ...
            RuleForEach(x => x.Sections)
                .SetValidator(new UpdateFormSectionDtoValidator());
        }
    }

    public class UpdateFormSectionDtoValidator : AbstractValidator<UpdateFormSectionDto>
    {
        public UpdateFormSectionDtoValidator()
        {
            RuleFor(x => x.Title)
            ...
            RuleForEach(x => x.Fields)
                .SetValidator(new UpdateFormFieldDtoValidator());
        }
    }
